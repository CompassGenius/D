...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('updates', url='https://t.me/Dustinreq')
            ],
            [
    ...
    buttons = [
        [
            InlineKeyboardButton('support', url='https://t.me/Dustinreq'),
            InlineKeyboardButton('channel', url='https://t.me/Dustinreq')
        ],
        [
            InlineKeyboardButton('Series & Movie', url=f'https://t.me/Dustinreq')
        ]
        ]
